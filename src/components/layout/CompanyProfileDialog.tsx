...
import { Building2, Globe, Mail, MapPin, Phone, Trash2, Upload } from "lucide-react";
        ...
        <div className="space-y-6 pt-4">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-[10px] text-muted-foreground text-center">
              Logo is saved locally in your browser (IndexedDB).
              <br />
              Stay lean when sharing quote links.
            </p>
          </div>
          ...
          <div className="grid gap-3">
            ...
            <div className="grid gap-1">
              <Label htmlFor="address" className="text-xs uppercase font-bold text-muted-foreground">
                Address
              </Label>
              <div className="relative">
            ...
            <div className="grid gap-4 grid-cols-2">
              <div className="grid gap-1">
                <Label htmlFor="contact" className="text-xs uppercase font-bold text-muted-foreground">
                  Contact
                </Label>
                <div className="relative">
              ...
              <div className="grid gap-1">
                <Label htmlFor="email" className="text-xs uppercase font-bold text-muted-foreground">
                  Email
                </Label>
                <div className="relative">
            ...
            <div className="grid gap-1">
              <Label htmlFor="website" className="text-xs uppercase font-bold text-muted-foreground">
                Website
              </Label>
              <div className="relative">
